...
app.use('/', indexRouter);
app.use('/it4895Q/user', userRouter);
app.use('/it4895Q/post', postRouter);
app.use('/it4895Q/comment', commentRouter);
app.use("/it4895Q/uploads", uploadsRouter);
app.use("/it4895Q/chatsocket", chatsocketRouter);
app.use("/it4895Q/search", searchRouter);
app.use("/it4895Q/notification", notificationRouter);
