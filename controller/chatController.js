...
module.exports = (io) => {
    io.on("connection", async(socket) => {
        ...
        socket.on('send2', async data => {
            ...
            request({
                url:`http://localhost:3000/it4895Q/chatsocket/set_message?receiverId=${partnerId}&token=${token}&content=${Content}&isUnread=${isUnread}&conversationId=${conversationId}`,
                method: "POST",
                json: true,
