...
const serverKey = require('../socialnetwork-92589-firebase-adminsdk-9j3kv-fa1cb4189f.json') //put the generated private key path here    
...
function newCommentNotification(receiverDeviceToken, sender, postId,userId) {
    ...
    let iconUrl = 'https://res.cloudinary.com/drdm8li6d/image/upload/v1671004370/facebook-comment-icon_e7kbvd.png'
